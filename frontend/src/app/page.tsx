          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Connect with verified properties near your university, find roommates, and make your student life easier.
              </p>
              <div className="flex space-x-4">
                <Link href="/properties" className="bg-indigo-600 text-white px-6 py-3 rounded-md hover:bg-indigo-700 font-medium">
                  Find Housing
                </Link>
                <Link href="/roommates" className="bg-white text-indigo-600 border border-indigo-600 px-6 py-3 rounded-md hover:bg-indigo-50 font-medium">
                  Find Roommates
                </Link>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                All properties and owners are verified to ensure safety and reliability for students.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center text-indigo-600 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">University Proximity</h3>
              <p className="text-gray-600">
                Find housing options with detailed information about distance to your university.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center text-indigo-600 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Roommate Matching</h3>
              <p className="text-gray-600">
                Find compatible roommates based on lifestyle preferences and academic needs.
              </p>
            </div>
          </div>
        </div>
