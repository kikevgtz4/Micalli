...
export default function HomePage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-surface shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <h1 className="text-2xl font-bold text-primary-600">UniHousing</h1>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <Link
                  href="/roommates"
                  className="bg-surface text-primary-600 border border-primary-500 px-6 py-3 rounded-md hover:bg-primary-50 font-medium"
                >
                  Find Roommates
                </Link>
              </div>
      ...
      {/* Footer */}
      <footer className="bg-stone-50 text-white py-12 mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
