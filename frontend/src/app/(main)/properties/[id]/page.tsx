...
const mockProperties = [
  {
    ...
    description:
      "This beautiful modern apartment is located just steps away from Tecnológico de Monterrey. It features 2 spacious bedrooms, a fully equipped kitchen, and a comfortable living area. Perfect for students looking for a convenient and comfortable place to live during their studies.",
    price: 8500,
    bedrooms: 2,
    bathrooms: 1,
    area: 75,
...
export default function PropertyDetailPage() {
  ...
  useEffect(() => {
    ...
    const fetchProperty = async () => {
      try {
        setIsLoading(true);
        const response = await apiService.properties.getById(
          parseInt(propertyId)
        );
