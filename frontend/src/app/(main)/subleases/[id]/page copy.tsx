            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <div className="flex items-center gap-3 mb-3">
                  ...
                  {sublease.isVerified && (
                    <div className="inline-flex items-center gap-1 px-3 py-1 bg-gradient-to-r from-green-50 to-emerald-50 text-green-700 rounded-full border border-green-200">
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 text-center border border-blue-100">
                  ...
                  <p className="font-semibold text-gray-900">
                    {sublease.subleaseType === 'entire_place' ? 'Entire' : 
                     sublease.subleaseType === 'private_room' ? 'Private' : 'Shared'}
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4 text-center border border-green-100">
                  <div className="inline-flex items-center justify-center w-10 h-10 bg-white rounded-lg mb-2">
                    <Square3Stack3DIcon className="h-6 w-6 text-green-600" />
                  </div>
              ...
              {/* Available Dates - Enhanced Design */}
              <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 rounded-2xl p-6 border border-green-100">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-white/70 backdrop-blur rounded-xl p-4">
                    ...
                    {sublease.isFlexible && (
                      <div className="mt-2 inline-flex items-center gap-1 px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs">
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                ...
                {sublease.additionalInfo && (
                  <div className="mt-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                    ...
                    <p className="text-sm text-blue-800">{sublease.additionalInfo}</p>
                  </div>
                )}
              </div>
                ...
                <div>
                  ...
                  {sublease.amenities.length > 9 && !showAllAmenities && (
                    <button
                      ...
                      className="mt-4 px-6 py-2.5 bg-white border-2 border-gray-900 rounded-xl hover:bg-gray-50 transition-colors text-sm font-semibold text-gray-900"
                    >
