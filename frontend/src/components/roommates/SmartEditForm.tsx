...
export default function SmartEditForm({
  ...
  const sections = [
    ...
    },
    {
      ...
      icon: PhoneIcon,
      description: "For safety - only shared with confirmed roommates",
      colorScheme: "secondary" as const,
      completion: calculateSectionCompletion(emergencyContact),
      content: (
        <div className="space-y-4">
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-6">
            <p className="text-sm text-yellow-800">
              This information will only be shared with your confirmed roommates for emergency purposes.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => onInputChange("emergency", "name", e.target.value)}
                className="w-full px-4 py-2.5 border border-stone-300 rounded-xl focus:ring-2 focus:ring-primary-500"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => onInputChange("emergency", "phone", e.target.value)}
                className="w-full px-4 py-2.5 border border-stone-300 rounded-xl focus:ring-2 focus:ring-primary-500"
